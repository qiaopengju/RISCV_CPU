...
HD_PWD='C:/Users/holme/Desktop/RISCVCPU/RISCVCPU.runs/TOP_CPU_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_CPU_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_CPU_0_0.tcl
